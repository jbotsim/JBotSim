 ...
 * </ul>
 *
 * <p>In order to store (into a file or elsewhere) one of these objects, an {@link io.jbotsim.serialization.xml.XMLBuilder}
 ...
 * {@link org.w3c.dom.Document} (the helper methods of {@link io.jbotsim.serialization.xml.XMLIO} can also be used).</p>
 *
